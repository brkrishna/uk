...
<div class='admin-box'>
    ...
    <?php echo form_open_multipart($this->uri->uri_string(), 'class="form-horizontal"'); ?>
                    ...
                    <div class="controls">
                        <ul class="thumbnails">
                            <li class="span6">
                                ...
                                <!--<p><?php echo anchor(SITE_AREA.'/content/party_documents/remove_attachment/'.$site_content->id,'Remove', 'class="btn btn-small btn-danger"'); ?></p>-->
                            </li>
                        </ul>
        ...
        <fieldset class='form-actions'>
            <input type='submit' name='save' class='btn btn-primary' value="<?php echo lang('site_content_action_create'); ?>" />
            <?php echo lang('bf_or'); ?>
